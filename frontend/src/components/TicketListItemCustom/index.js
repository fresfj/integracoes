...
import { makeStyles, alpha, getContrastRatio } from '@material-ui/core/styles'
...
import Open from '@material-ui/icons/CallMade'
              ...
              >
                ...
                <span className={classes.secondaryContentSecond}>
                  {ticket?.whatsapp?.name ? (
                    <Tooltip
                      title={ticket?.whatsapp?.name?.toUpperCase()}
                      placement="top-end"
                      arrow
                      size="md"
                    >
        ...
        <span className={classes.buttonContent}>
          {ticket.status === 'pending' && (
            <Tooltip title={i18n.t('ticketsList.buttons.accept')}>
              <IconButton
                size="small"
                className={classes.checkHoverFocus}
          ...
          {ticket.status !== 'closed' && (
            <Tooltip title={i18n.t('ticketsList.buttons.closed')}>
              <IconButton
                size="small"
                className={classes.closeHoverFocus}
          ...
          {ticket.status === 'closed' && (
            <Tooltip title={i18n.t('ticketsList.buttons.reopen')}>
              <IconButton
                size="small"
                className={classes.openHoverFocus}
